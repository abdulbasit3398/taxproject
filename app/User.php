...
class User extends Authenticatable
{
    ...
    public function billingStatementFormat($number)
    {
        $settings = Utility::settings();

        return $settings["billingstatement_prefix"] . sprintf("%05d", $number);
    }
    ...
    public function clientNumberFormat($number)
    {
        $settings = Utility::settings();
    ...
    {
        return Client::where('created_by', '=', $this->creatorId())->count();
    }
