                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="custom-control custom-radio mb-3">
                      <input type="radio" id="customRadio81" name="product_or_service" value="Products" class="custom-control-input" {{(isset($settings['product_or_service']) && $settings['product_or_service'] == 'Products')?'checked':''}} checked>
                      <label class="custom-control-label" for="customRadio81">{{__('Products')}}</label>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="custom-control custom-radio mb-3">
                      <input type="radio" id="customRadio71" name="product_or_service" value="Services" class="custom-control-input" {{(isset($settings['product_or_service']) && $settings['product_or_service'] == 'Services')?'checked':''}}>
                      <label class="custom-control-label" for="customRadio71">{{__('Services')}}</label>
                    </div>
                  </div>
                </div>
