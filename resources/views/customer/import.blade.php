<div class="card bg-none card-box">
  <form method="POST" id="import_customers_form" accept-charset="UTF-8" enctype="multipart/form-data" action="{{route('import-customers')}}">
    @csrf
...
<script>
  $(document).ready(function(){
    $('#import_customers_form').submit(function(e){
      if($('#select_tin').val() == null)
      {
        ...
        $.ajax({
         url:"{{ route('import-customers-file') }}",
         method:"POST",
