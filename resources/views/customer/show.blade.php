...
<div class="row">
  <div class="col-md-4 col-lg-4 col-xl-4">
    <div class="card pb-0 customer-detail-box">
      ...
      <div class="p-4">
        <h5 class="report-text gray-text mb-0">{{$customer['last_name']}}</h5>
        <h5 class="report-text gray-text mb-0">{{$customer['name']}}</h5>
        <h5 class="report-text gray-text mb-0">{{$customer['middle_name']}}</h5>
        <h5 class="report-text gray-text mb-0">{{$customer['email']}}</h5>
        <h5 class="report-text gray-text mb-0">{{$customer['contact']}}</h5>
        <h5 class="report-text gray-text mb-0">{{$customer['customer_tin']}}</h5>
      </div>
    </div>
  </div>
  <div class="col-md-4 col-lg-4 col-xl-4">
    <div class="card pb-0 customer-detail-box">
      ...
      <div class="p-4">
        ...
        <h5 class="report-text gray-text mb-0">{{$customer['billing_city'].', '.$customer['billing_country']}}</h5>
      </div>
    </div>
  </div>
  <div class="col-md-4 col-lg-4 col-xl-4">
    <div class="card pb-0 customer-detail-box">
      ...
      <div class="p-4">
        <h5 class="report-text gray-text mb-0">{{$customer['person_name']}}</h5>
        <h5 class="report-text gray-text mb-0">{{$customer['person_mbile']}}</h5>
        <h5 class="report-text gray-text mb-0">{{$customer['person_fax']}}</h5>
        <h5 class="report-text gray-text mb-0">{{$customer['person_email']}}</h5>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="p-4">
            ...
            <h5 class="report-text mb-3">{{$customer['branch_name']}}</h5>
            <h5 class="report-text gray-text mb-0">{{__('Organization Name')}}</h5>
            <h5 class="report-text mb-3">{{$customer['organization_name']}}</h5>
            ...
            <h5 class="report-text mb-3">{{$customer['tax_type']}}</h5>
