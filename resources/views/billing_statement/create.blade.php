...
@section('page-title')
{{__('Billing Statement Create')}}
@endsection
@push('script-page')
<script src="{{asset('assets/js/jquery-ui.min.js')}}"></script>
<script src="{{asset('assets/js/jquery.repeater.min.js')}}"></script>
<script>
  function calculate_vat(subTotal)
  {
    var netVAT = (subTotal/1.12);
    var lessVAT = subTotal - netVAT;
    var addVAT = lessVAT;

    $('.netVAT').html(netVAT.toFixed(2));
    $('.lessVAT').html(lessVAT.toFixed(2));
    $('.addVAT').html(addVAT.toFixed(2));
  }
  var selector = "body";
...
@section('content')
<div class="row">
  {{ Form::open(array('url' => 'billing-statement','class'=>'w-100')) }}
  <div class="col-12">
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="form-group" id="customer-box">
              <div class="input-group">
                ...
                {{ Form::select('client_id', $customers,$customerId, array('class' => 'form-control select2','id'=>'customer','data-url'=>route('billing-statement.client'),'required'=>'required')) }}
              </div>
            </div>
          ...
          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  {{ Form::label('invoice_number', __('Billing Statement Number'),['class'=>'form-control-label']) }}
                  <div class="form-icon-user">
              ...
              <div class="col-md-6">{{ Form::label('category_id', __('Branch'),['class'=>'form-control-label']) }}
                <select class="form-control font-style select2" name="branch_id" required>
                  <option value="">Select Branch Code</option>
                  @foreach($company_branchs as $company_branch)
                    <option value="{{$company_branch->id}}">{{$company_branch->branch_code}}</option>
                  @endforeach
                </select>
              </div>
          ...
          <table class="table table-striped mb-0" data-repeater-list="items" id="sortable-table">
            ...
            <tfoot>
              <tr>
                ...
                <!-- <td></td> -->
                <td>
                  <strong>Total Sales (VAT Inclusive)</strong>
                </td>
              ...
              <tr>
                ...
                <!-- <td></td> -->
                <td>
                  <strong>Less:VAT</strong>
                </td>
                <td class="text-right lessVAT">
                  0.00
                </td>
                <td></td>
              </tr>
              <tr>
                ...
                <!-- <td></td> -->
                <td>
                  <strong>Amount: Net of VAT</strong>
                </td>
                <td class="text-right netVAT">
                  0.00
                </td>
                <td></td>
              </tr>
              ...
              <tr>
                ...
                <td class="lessVAT">0.00</td>
                <!-- <td>&nbsp;</td> -->
                <!-- <td>&nbsp;</td> -->
                <td class="blue-text"><strong>{{__('Total Amount Due')}} ({{\Auth::user()->currencySymbol()}})</strong></td>
