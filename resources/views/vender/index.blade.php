...
<div class="all-button-box row d-flex justify-content-end">
  ...
  @can('create vender')
    ...
    <a href="#" data-size="2xl" data-url="{{ route('vender.create') }}" data-ajax-popup="true" data-title="{{__('Create New Supplier')}}" class="btn btn-xs btn-white btn-icon-only width-auto commonModal">
      <i class="fas fa-plus"></i> {{__('Create')}}
    </a>
    <a href="#" data-size="2xl" data-url="{{ route('vender.import') }}" class="btn btn-xs btn-white btn-icon-only width-auto commonModal" data-ajax-popup="true" data-title="{{__('Import Vender')}}">
      <span class="btn-inner--icon"><i class="fas fa-file"></i></span>
      <span class="btn-inner--text"> {{__('Import')}}</span>
    </a>
  
  @endcan
    <a href="{{route('exports-vendors')}}" class="btn btn-xs btn-white btn-icon-only width-auto commonModal">
      <span class="btn-inner--icon"><i class="fas fa-file"></i></span>
