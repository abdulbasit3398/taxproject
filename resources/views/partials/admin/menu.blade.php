  ...
  <div class="scrollbar-inner">
    <div class="div-mega">
      <ul class="navbar-nav navbar-nav-docs">
        ...
        <li class="nav-item">
          <a href="{{ route('productservice.pos') }}" class="nav-link {{ (Request::segment(2) == 'pos')?'active':''}}">
            <i class="fas fa-shopping-cart"></i>{{__('POS')}}
          </a>
        </li>

        @if(Gate::check('manage product & service'))
        <li class="nav-item">
          <a href="{{ route('productservice.index') }}" class="nav-link {{ (Request::segment(1) == 'productservice' && Request::segment(2) != 'pos')?'active':''}}">
        ...
        <li class="nav-item">
          <a href="{{ route('client.index') }}" class="nav-link {{ (Request::segment(1) == 'client')?'active':''}}">
            <i class="fas fa-sticky-note"></i>{{__('Client')}}
          </a>
        </li>
        @endif
        ...
        <li class="nav-item">
          <a class="nav-link {{ (Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note' || Request::segment(1) == 'sale_transections' || Request::segment(1) == 'sale-vat-relief')?' active':'collapsed'}}" href="#navbar-income" data-toggle="collapse" role="button" aria-expanded="{{ (Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note' || Request::segment(1) == 'sale_transections' || Request::segment(1) == 'sale-vat-relief')?'true':'false'}}" aria-controls="navbar-income">
            <i class="fas fa-money-bill-alt"></i>{{__('Sales')}}
            <i class="fas fa-sort-up"></i>
          </a>
          <div class="collapse {{ (Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note' || Request::segment(1) == 'credit-note' || Request::segment(1) == 'sale_transections' || Request::segment(1) == 'sale-vat-relief')?'show':''}}" id="navbar-income">
            <ul class="nav flex-column submenu-ul">
              <li class="nav-item {{ (Request::route()->getName() == 'sale_transections.index') ? ' active' : '' }}">
                <a href="{{ route('sale_transections.index') }}" class="nav-link">Sales Transections</a>
              </li>
              <li class="nav-item {{ (Request::route()->getName() == 'sale-vat-relief') ? ' active' : '' }}">
                <a href="{{ route('sale-vat-relief') }}" class="nav-link">Sales VAT Relief</a>
              </li>
              @can('manage invoice')
        ...
        <li class="nav-item">
          <a class="nav-link {{ (Request::segment(1) == 'chart-of-account' || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance' ||  Request::segment(1) == 'subsidiary-sales-journal' ||  Request::segment(1) == 'report.cash.receipts' ||  Request::segment(1) == 'report.general.journal')?' active':'collapsed'}}" href="#navbar-double-entry" data-toggle="collapse" role="button" aria-expanded="{{ (Request::segment(1) == 'bill' )?'true':'false'}}" aria-controls="navbar-double-entry">
            <i class="fas fa-balance-scale"></i>{{__('Double Entry')}}
            <i class="fas fa-sort-up"></i>
          </a>
          <div class="collapse {{ (Request::segment(1) == 'chart-of-account'  || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance' || Request::segment(1) == 'subsidiary-sales-journal' || Request::segment(1) == 'cash-receipts' || Request::segment(1) == 'general-journal')?'show':''}}" id="navbar-double-entry">
            <ul class="nav flex-column submenu-ul">
              ...
              @endcan
              <li class="nav-item {{ (Request::route()->getName() == 'subsidiary.sales.journal' ) ? ' active' : '' }}">
                <a href="{{route('subsidiary.sales.journal')}}" class="nav-link">Subsidiary Sales Journal</a>
              </li>
              <li class="nav-item {{ (Request::route()->getName() == 'report.cash.receipts' ) ? ' active' : '' }}">
                <a href="{{route('report.cash.receipts')}}" class="nav-link">Cash Receipts</a>
              </li>
              <li class="nav-item {{ (Request::route()->getName() == 'report.general.journal' ) ? ' active' : '' }}">
                <a href="{{route('report.general.journal')}}" class="nav-link">General Journals</a>
              </li>
            </ul>
          </div>
        </li>
        ...
        <li class="nav-item">
          ...
          'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type' || Request::segment(1) == 'fui')?'true':'false'}}" aria-controls="navbar-constant">
          <i class="fas fa-cog"></i>{{__('Constant')}}
          <i class="fas fa-sort-up"></i>
        </a>
        <div class="collapse {{ (Request::segment(1) == 'taxes' || Request::segment(1) == 'product-category' || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type' || Request::segment(1) == 'fui')?'show':''}}" id="navbar-constant">
          <ul class="nav flex-column submenu-ul">
            ...
            @endcan
            <li class="nav-item {{ (Request::route()->getName() == 'fui' ) ? 'active' : '' }}">
              <a href="{{route('fui')}}" class="nav-link">{{ __('Frequently Used Items') }}</a>
            </li>
          </ul>
        </div>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::segment(1) == 'rdo' || Request::segment(1) == 'coa' || Request::segment(1) == 'atc' || Request::segment(1) == 'lob' || Request::segment(1) == 'reference' || Request::segment(1) == 'expense_type' || Request::segment(1) == 'organisation-type') ? 'active':'collapsed'}}" href="#navbar-reports" data-toggle="collapse" role="button" aria-expanded="{{ (Request::segment(1) == 'rdo' || Request::segment(1) == 'coa' || Request::segment(1) == 'atc' || Request::segment(1) == 'lob' || Request::segment(1) == 'reference' || Request::segment(1) == 'expense_type' || Request::segment(1) == 'organisation-type') ? 'true':'false'}}" aria-controls="navbar-reports">
          <i class="fas fa-cog"></i> {{__('Defaults')}}
          <i class="fas fa-sort-up"></i>
        </a>
        <div class="collapse {{ (Request::segment(1) == 'rdo' || Request::segment(1) == 'coa' || Request::segment(1) == 'atc' || Request::segment(1) == 'lob' || Request::segment(1) == 'reference' || Request::segment(1) == 'expense_type' || Request::segment(1) == 'organisation-type') ? 'show':''}}" id="navbar-reports">
          <ul class="nav flex-column submenu-ul">
            <li class="nav-item {{ (Request::route()->getName() == 'rdo.index' ) ? 'active' : '' }}">
              <a class="nav-link" href="{{route('rdo.index')}}"> {{__('RDO List')}}</a>
            </li>
            <li class="nav-item {{ (Request::route()->getName() == 'coa.index' ) ? 'active' : '' }}">
              <a class="nav-link" href="{{route('coa.index')}}"> {{__('COA')}}</a>
            </li>
            <li class="nav-item {{ (Request::route()->getName() == 'atc.index' ) ? 'active' : '' }}">
              <a class="nav-link" href="{{route('atc.index')}}"> {{__('ATC')}}</a>
            </li>
            <li class="nav-item {{ (Request::route()->getName() == 'lob.index' ) ? 'active' : '' }}">
              <a class="nav-link" href="{{route('lob.index')}}"> {{__('LOB')}}</a>
            </li>
            <li class="nav-item {{ (Request::route()->getName() == 'reference.index' ) ? 'active' : '' }}">
              <a class="nav-link" href="{{route('reference.index')}}"> {{__('Reference')}}</a>
            </li>
            <li class="nav-item {{ (Request::route()->getName() == 'expense_type.index' ) ? 'active' : '' }}">
              <a class="nav-link" href="{{route('expense_type.index')}}"> {{__('Expense Type')}}</a>
            </li>
            <li class="nav-item {{ (Request::route()->getName() == 'organisation-type.index' ) ? 'active' : '' }}">
              <a class="nav-link" href="{{route('organisation-type.index')}}"> {{__('Organization Type')}}</a>
            </li>
